                    ...
                    <ul class="nav navbar-nav side-nav" id="item-list">
                    	<li>
                            <div class="btn-group" style="left: 20px;top: 15px;margin-bottom: 25px;">
                              <button type="button" class="btn btn-default" style="background: #0050A7;border: 1px solid #0088CC;">
                <a href="/" style="color: #eee; font-weight: 300;">Contacts</a></button>
                              <button type="button" class="btn btn-default" style="background: #232323;border: 1px solid #0088CC;"><a href="/?list=address">Adresses</a></button>
                    		</div>
    					</li>
    				</ul>
                </div>
