            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <spring:message code="createContactForm.title" />
                    </h3>
                </div>
                ...
                <div class="panel-body">
                    <form:form method="POST" commandName="contactModel" role="form">
                        <div class="form-group">
                            ...
                            <form:input basename="messages" path="m_contactFirstName"  class="form-control" id="m_contactFirstName" />
                        ...
                        <div class="form-group">
                            ...
                            <form:input basename="messages" path="m_contactLastName"  class="form-control" id="m_contactLastName" />
                        ...
                        <div class="form-group">
                            ...
                            <form:input basename="messages" path="m_contactMail"  class="form-control" id="m_contactMail" />                           
                        ...
                        <div class="form-group">
                            ...
                            <form:input basename="messages" path="m_contactBirthDate"  class="form-control" id="m_contactBirthDate" type="date"/>
